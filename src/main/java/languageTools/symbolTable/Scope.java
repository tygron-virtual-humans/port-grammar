...
public interface Scope {
	 ...
	 * 
	 * @param sym The name of the symbol that is added to the scope.
	 * @return {@code true} if symbol was added; {@code false} if symbol is duplicate already present in table.
	 */
	public boolean define(Symbol sym);
	
	/**
	 * Resolves a reference (use) of a name within the scope and connects it to its definition.
	 * 
	 * @param name The name that is referenced and needs to be resolved. 
