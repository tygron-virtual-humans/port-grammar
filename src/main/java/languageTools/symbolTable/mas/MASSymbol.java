...
/**
 * An agent symbol associates an agent name in the MAS file with an agent file
 * listed in the same MAS file. This info is derived from the agentfiles section
 * in a MAS file.
 */
public class MASSymbol extends Symbol {
	...
	public String toString() {
		return "<AgentSymbol: " + getName() + ", " + this.file + ">";
	}
