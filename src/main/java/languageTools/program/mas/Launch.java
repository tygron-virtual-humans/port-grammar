...
/**
 * A launch (instruction) is an instruction, part of a launch rule, in a MAS file to launch an agent.
 */
public class Launch {
	 ...
	 * 
	 * @param agentFile The agent file used by this launch instruction.
	 */
	...
	/**
	 * Creates a given name for agent, derived from either the name of the entity the agent is connect
	 * to or a given name, and the number of applications of the launch instruction. 
	 *  
	 * @param entityName The name of the entity that this agent is connected to, if any. Assumes that entity names are unique.
	 * @param applications The number of times this instruction has been applied. Used to differentiate agents when this
	 * 			instruction is applied more than once.
	...
	public String getGivenName(String entityName, int applications) {
		if (givenName.equals("*")) {
			...
			return givenName + (applications == 0 ? "" : applications);
		}
	}

	/**
	 * @param givenName The name that should be given to the agent that is launched.
	 */
	...
	public int getNumberOfAgentsToLaunch() {
		return numberOfAgentsToLaunch;
	}

	/**
	 * @param numberOfAgentsToLaunch The number of agents that should be launched.
	 */
	...
	public String toString() {
		return "Launch[basename=" + givenName + ", nr="
				+ numberOfAgentsToLaunch + " file=" + agentFile + "]";
	}
